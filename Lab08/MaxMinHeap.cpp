...
MaxMinHeap::~MaxMinHeap() { delete[] this->_heap; }

void MaxMinHeap::Push(int val) {
    this->_size++;
    this->_heap[this->_size] = val;
}

void MaxMinHeap::Insert(int val) {
    this->Push(val);
    this->_upHeap(this->_size);
}

void MaxMinHeap::_upHeap(int index) {
    if (index == ROOT)
        return;
...
int MaxMinHeap::_level(int index) { return (int)floor(log2(index)); }

bool MaxMinHeap::_isMinNode(int index) { return this->_level(index) % 2 != 0; }

int MaxMinHeap::_parentIndex(int index) { return (int)floor(index / 2); }

bool MaxMinHeap::_shouldSwap(int parentIndex, int index) {
    auto pValue = this->_heap[parentIndex];
...
void MaxMinHeap::_printNode(int index) {
...
bool MaxMinHeap::_isLeaf(int index) { return this->_leftChild(index) == 0 && this->_rightChild(index) == 0; }

int MaxMinHeap::_leftChildIndex(int index) { return 2 * index; }

int MaxMinHeap::_rightChildIndex(int index) { return (2 * index) + 1; }

int MaxMinHeap::_leftChild(int index) { return this->_heap[this->_leftChildIndex(index)]; }

int MaxMinHeap::_rightChild(int index) { return this->_heap[this->_rightChildIndex(index)]; }

void MaxMinHeap::_downHeap(int index) {
...
int MaxMinHeap::_findMinIndexHelper(int index, int minIndex) {
...
int MaxMinHeap::_findMinIndex(int index) { return this->_findMinIndexHelper(index, index); }

int MaxMinHeap::_findMaxIndexHelper(int index, int maxIndex) {
...
int MaxMinHeap::_findMaxIndex(int index) { return this->_findMaxIndexHelper(index, index); }

int MaxMinHeap::_findMin(int index) { return this->_heap[this->_findMinIndex(index)]; }

int MaxMinHeap::_findMax(int index) { return this->_heap[this->_findMaxIndex(index)]; }
...
int MaxMinHeap::FindMin() { return this->_findMin(ROOT); }

int MaxMinHeap::FindMax() { return this->_findMax(ROOT); }
